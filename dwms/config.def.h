...
static const char *fonts[] = {"Fixedsys Excelsior:size=12:antialias=true:autohint=false"};
static const char dmenufont[] = "Fixedsys Excelsior:size=12:antialias=true:autohint=false";
